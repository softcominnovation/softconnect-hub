...
1. `docs/softconnect-spec-tecnica.md` — architecture, decisions, schema, endpoints
2. `docs/softconnect-plano-implementacao.md` — current project state and active phase
3. `README.md` — overview and setup guide
